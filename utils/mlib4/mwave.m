...
%
% ARGUMENTS
% meanwave    vector containing the mean spike waveform (required)
% si          scalar indicating sampling interval in µs (required)
% plot        optional - a figure will be created with the mean wave and 
% 
% EXAMPLE
% mwave(meanwave,50,'plot')
%
